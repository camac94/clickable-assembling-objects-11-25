...
instructionsreal = visual.TextStim(win=win, name='instructionsreal',
    text='Click on the box under your answer to select it. The box will turn black once selected.',
    font='times new roman',
